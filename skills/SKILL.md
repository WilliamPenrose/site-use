---
name: site-use
description: "Personal AI for social media — collect tweets, daily digest, track topics. Use when the user wants to browse Twitter/X, get a summary of what's happening, monitor topics long-term, or fetch social media data. Examples: 'what's hot today', 'grab latest tweets', 'search Twitter for AI news', 'track this topic for a week', 'set up site-use'"
...
| **Deep dive** | "tell me more about", "expand on", "show replies" | → [twitter-commands.md](./references/twitter-commands.md) (tweet_detail) |
...
| **RateLimited** | Stop ALL twitter commands. Wait 15+ min before retrying |
...
- [references/twitter-commands.md](./references/twitter-commands.md) — All Twitter CLI commands, flags, examples
