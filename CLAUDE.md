...
This project is indexed by GitNexus as **site-use** (870 symbols, 1958 relationships, 58 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
