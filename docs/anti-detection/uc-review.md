# undetected-chromedriver (UC) 逐 Feature 评审

> 返回 [汇总](README.md)
>
> 参考文档：`d:\src\knowledge\browser-use\undetected-chromedriver-anti-detection-guide.md`
> 参考代码：`d:\src\spider\undetected-chromedriver\` @ `757ed6a`
